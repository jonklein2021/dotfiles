...
vim.keymap.set({ "n", "i", "v" }, "<C-b>", "<nop>", { desc = "idk i just dislike this motion" })
vim.keymap.set({ "n", "i", "v" }, "<Leader>a", "<Esc>gg^vG$", { desc = "Ctrl-a selects all" })
...
vim.keymap.set({ "n", "i", "v" }, "<C-f>", "<Cmd>Telescope find_files<CR>", { desc = "Searches for files" })
vim.keymap.set({ "n", "i", "v" }, "<C-_>", require("telescope.builtin").live_grep, { desc = "Live Grep" })
